    ...
    useEffect(()=>{
        const getProductById = async () =>{
            try{
                ...
                setTanggal_masuk_barang(response.data.tanggal_masuk_barang);
                setNama_barang(response.data.nama_barang);
                setSatuan(response.data.satuan);
                setTerima(response.data.terima);
                setKeluar(response.data.keluar);
                setSo_akhir(response.data.so_akhir);
                setSaldo_awal(response.data.saldo_awal);
                setPenerima(response.data.penerima);
                setPengeluaran(response.data.pengeluaran);
                setHarga_perpics (response.data.harga_perpics);
                setJumlah(response.data.jumlah);
                setTanggal_keluar_barang(response.data.tanggal_masuk_barang);
  ...
  return (
    <div>
        ...
        <h2 className="subtitle">Edit Products</h2>
         <div className="card is-shadowless kolom garis">
